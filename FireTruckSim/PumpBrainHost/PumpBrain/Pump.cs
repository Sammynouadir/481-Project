...
namespace PumpBrain
{
    internal class Pump
    {
        ...
        private bool _ptoEngaged;

        public Pump(double gearRatio, double flowResistanceCoefficient, double quadraticFlowCoefficient, double minPumpRpm, double maxPumpRpm, double minPressure, double maxPressure)
        {
            _gearRatio = gearRatio;
            _flowResistanceCoefficient= flowResistanceCoefficient;
